...
{{< figure src="https://i.ibb.co/41bTx9g/1242x2688bb-1.png" alt="Example Groups in Quick Splits." width="40%" caption="Groups in Quick Splits.">}}
...
{{< figure src="https://i.ibb.co/jbxy6yT/Image-LR-Merge-2.png" alt="recurring requests and autogenerated venmo request" width="80%" caption="Recurring Requests in Quick Splits (left) and the autogenerated Venmo request (right).">}}
...
{{< figure src="https://i.ibb.co/2N7xF0h/Image-LR-Merge.png" alt="credit card transaction splitting and autogenerated venmo request" width="80%" caption="Credit Card Transactions in Quick Splits (left) and the autogenerated Venmo request (right).">}}
